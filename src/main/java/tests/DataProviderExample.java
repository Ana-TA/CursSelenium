...
public class DataProviderExample extends BaseTest{
	...
	public Object[][] bookNameDataProvider() {
		...
		Object[][] data = new Object[5][2]; //5 carti cu cate 2 campuri fiecare: titlu, poza
		...
		data[2][0] = "The long road in the deep Silence";
		data[2][1] = "book5.jpg";
	...
	@Test(dataProvider = "bookNameDataProvider") // daca era in alta clasa-->dataProviderClass="numeClasa", dataProvider="bookNameDataProvider"
