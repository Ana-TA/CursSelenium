...
public class XpathExample2 extends BaseTest{
	...
	public void xpathTest() {
		...
		//following (coboara fara sa tina cont de realatie ierarhica)
		...
		//preceding (urca fara sa tina cont de realatie ierarhica)
	...
	public void xpathTest2() {
		...
		// ne referim la paginatia din shop (click pe Books)
		/*
		 * xpath:   //*[contains(@class, 'page-numbers')] -->gaseste 4 element (parintele UL si 3 copii-un tagname span si 2 tagnameuri a care au aceeasi clasa)
		 * 
